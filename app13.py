# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 13:23:49 2020
...
def create_app8_ui():
  ...
  html.H1(children = 'Terrorism Analysis and Finding Insights', id='Main_title',
              style = {
                         'color' : '#f0ce60',
                         'font-family' : 'Copperplate',
                         'text-align' : 'center',
  ...
  dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map", style=tab_style2, selected_style=tab_selected_style2 , children=[
          ...
          html.Div([
             ...
             html.Div([
              ...
              ], style = {'margin-top' : '50px','border-radius' : '10px', 'padding-top' : '10px' ,'backgroundColor': "#9caeb5"}),
  ...
  ],style={"background-image": 'url("/assets/images.jpg")',
...
# .custom-dropdown .Select-control, .Select div, .is-open>.Select-control{
#   color: black;
#   border-color: #e3a700;
